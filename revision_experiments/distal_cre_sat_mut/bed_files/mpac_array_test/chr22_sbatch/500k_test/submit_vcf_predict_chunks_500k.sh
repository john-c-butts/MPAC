#!/bin/bash -l
#SBATCH --job-name=mpac_array_test_500k
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
--use_vmap TRUE \
--vcf_file /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/distal_cre_sat_mut/bed_files/vcf_like/chunked_vcfs/k562_chr22_cre_chunk_${SLURM_ARRAY_TASK_ID}_500k.vcf \
--fasta_file /projects/tewhey-lab/buttsj/genomes/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta \
--output /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/distal_cre_sat_mut/bed_files/mpac_array_test/k562_chr22_test/k562_chr22_cre_chunk_${SLURM_ARRAY_TASK_ID}_500k_mpac_017.vcf \
--relative_start 9 \
--relative_end 181 \
--step_size 10 \
