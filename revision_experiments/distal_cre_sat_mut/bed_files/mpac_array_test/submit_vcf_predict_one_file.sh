...
--use_vmap TRUE \
--vcf_file /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/distal_cre_sat_mut/bed_files/vcf_like/chunked_vcfs/all_chr22_k562_enhancers.vcf \
--fasta_file /projects/tewhey-lab/buttsj/genomes/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta \
--output /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/distal_cre_sat_mut/bed_files/mpac_array_test/k562_chr22_test/all_chr22_k562_enhancers_mpac_017.vcf \
--relative_start 9 \
--relative_end 181 \
--step_size 10 \
