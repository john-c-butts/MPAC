#!/usr/bin/env python3
"""
Merge per-chromosome padding emVars TSVs into a single file.

Usage:
    python scripts/merge_padding_results.py
"""
...
input_dir = 'results_final/padding_per_chrom'
output_path = 'results_final/padding_emVars_gnomAD_v4.tsv'

chrom_files = sorted(
    [f for f in os.listdir(input_dir) if f.endswith('_padding_emVars.tsv')],
