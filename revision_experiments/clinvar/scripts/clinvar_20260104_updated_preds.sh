#!/bin/bash -l
#SBATCH --job-name=clinvar_20260104
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
#SBATCH --array=1-22
#SBATCH --output=/projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/clinvar/scripts/mpac_slurm_output/slurm_%j_%a.out
...
#get vcf
vcf_file="/projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/clinvar/processed_data/chrom_vcfs/chr${SLURM_ARRAY_TASK_ID}_clinvar_20260104.tsv"
...
--output /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/clinvar/processed_data/mpac_preds/chr${SLURM_ARRAY_TASK_ID}_clinvar_20260104.vcf \
--window_size 200 \
--relative_start 9 \
--relative_end 180 \
--step_size 10 \
