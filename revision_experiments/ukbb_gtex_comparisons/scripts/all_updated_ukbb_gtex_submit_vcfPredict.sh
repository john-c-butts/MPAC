...
--output /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/ukbb_gtex_comparisons/processed_data/predictions/chr${SLURM_ARRAY_TASK_ID}_ukbb_gtex_all_blacklist_filtered_v1_all_vcfPredict.pt \
--window_size 200 \
--relative_start 9 \
--relative_end 180 \
--step_size 10 \
