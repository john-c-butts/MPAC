...
All scripts are located in the `v2/` subdirectory. The full pipeline is orchestrated by
`v2/run_v2_pipeline.sh`. Run as `bash run_v2_pipeline.sh` (all steps) or
`bash run_v2_pipeline.sh <N>` (single step). PromoterAI seqlet calling is delegated to
`v2/run_promoterAI_seqlet_calling.sh`, which is invoked by the main pipeline script.
...
**Output:** `v2/processed_data/all.mpac.preds.tabix.filtered.gencode.250bp.v2.vcf`
...
**Output:** `v2/processed_data/PrimateAI_and_PromoterAI_scores.hg38.250bp.v2.filtered.vcf`
...
**`v2/v2_mpac_seqlet_calling.py`**  
Reads per-cell-type MPAC predictions from the tabix-filtered VCF; calls and annotates seqlets for K562, HepG2, and SK-N-SH.  
**Outputs:**
- `v2/mpac/processed_data/mpac_{k562,hepg2,sknsh}_seqlet_calls_v2.tsv`
- `v2/mpac/processed_data/mpac_{k562,hepg2,sknsh}_full_ann_seqlets_v2.tsv`
- `v2/processed_data/bed_files/{k562,hepg2,sknsh}_mpac_annotated_seqlets_01_v2.bed`

**`v2/v2_parm_seqlet_calling_tabix.py`**  
Calls seqlets on PARM predictions (tabix-filtered VCFs) for K562 and HepG2.  
**Outputs:**
- `v2/PARM/processed_data/parm_{k562,hepg2}_tangermeme_seqlet_calls_v2_tabix.tsv`
- `v2/PARM/processed_data/parm_{k562,hepg2}_tangermeme_full_ann_seqlets_v2_tabix.tsv`
- `v2/processed_data/bed_files/{k562,hepg2}_parm_annotated_seqlets_01_v2_tabix.bed`

**`v2/v2_promoterAI_seqlet_calling.py`**  
Calls seqlets on PromoterAI predictions.  
**Outputs:**
- `v2/promoterAI/processed_data/promoterAI_seqlet_calls_v2.tsv`
- `v2/promoterAI/processed_data/promoterAI_full_ann_seqlets_v2.tsv`
- `v2/processed_data/bed_files/promoterAI_annotated_seqlets_01_v2.bed`
...
**Outputs:** `v2/processed_data/bed_files/{K562,HEPG2,SKNSH}_bedOps_merged_noMin_seqlets_01_v2.bed`, `parm_{k562,hepg2}_tangermeme_bedOps_merged_noMin_seqlets_01_v2.bed`, `promoterAI_bedOps_merged_noMin_seqlets_01_v2.bed`
...
**Outputs:** `v2/processed_data/bed_files/{K562,HEPG2,SKNSH}_01_noMin_250bp_pro_cover_v2.bed`, `promoterAI_01_noMin_250bp_pro_cover_v2.bed`

---

### Step 6 — Assign representative TFs to merged seqlet intervals
**Script:** `v2/v2_assign_representative_tfs.py`
...
**Outputs** (`v2/processed_data/bed_files/`):
...
**Script:** `v2/v2_merge_predictions.py`
...
**Input:** `v2/processed_data/mpac.250bp.promoter.preds.with.annotations.v2.tsv`  
**Outputs:**
...
**Outputs:**
- `v2/processed_data/mpac.250bp.promoter.preds.with.annotations.parm.act.promoterAI.parm.sat.mut4.phyloP.annotated.v2.vcf` (470-way)
- `v2/processed_data/mpac.250bp.promoter.preds.with.annotations.parm.act.promoterAI.parm.sat.mut4.phyloP.annotated.241.mamm.v2.vcf` (241-mammalian)
...
**Outputs** (`v2/processed_data/annotated_preds/`): `mpac_{k562,hepg2,sknsh}_seqlet_filtered_preds_v2.tsv`, `promoterAI_seqlet_filtered_preds_v2.tsv`, `parm_{k562,hepg2}_seqlet_filtered_preds_v2.tsv`

---

## Analysis notebooks

All analysis notebooks are located in `v2/`.

### `v2/plot_tf_distributions_basic_filter_v1.ipynb`
...
**Output:** `v2/plots/All_promoter_seqlet_counts_v2.pdf`

---

### `v2/promoter_prediction_scatters_basic_filter_v1.ipynb`
...
**Input:** `v2/processed_data/mpac.250bp.promoter.preds.with.annotations.parm.act.promoterAI.parm.sat.mut4.phyloP.annotated.v2.vcf`  
**Outputs:**
- `v2/plots/mpac_parm_promoterAI_promoter_prediction_correlations_heatmap_v2.pdf`
- `v2/plots/mpac_parm_promoterAI_promoter_prediction_concordance_heatmap_v2.pdf`
- `v2/plots/hits_by_phyloP_ratio_v2.pdf`

---

### `v2/promoter_seqlet_comparisons_basic_filter_v1.ipynb`
...
**Outputs:**
- `v2/plots/seqlet_positioning_by_model_v2.pdf`
- `v2/plots/percent_tf_usage_by_model_v2.pdf`
- `v2/plots/percent_usage_correlation_scatters_v2.pdf`

---

### `v2/gtex_v10_fineMapping_comparison_basic_filter_v1.ipynb`
...
**Inputs:**
- `v2/processed_data/complete.merged.250bp.promoters.exon.filtered.v2.tsv`
- `raw_data/gtex_v10_fineMapping/SuSiE_fineMapped/` (per-tissue parquet files)

**Outputs:**
- `v2/plots/eQTL_effect_size_comparison_gtex_v10_v3.pdf`
- `v2/plots/eQTL_beta_corr_summary_gtex_v10_v2.svg`
- `v2/plots/eQTL_aurocs_gtex_v10_v2.pdf`
- `v2/plots/eQTL_auroc_summary_gtex_v10_v2.pdf`
