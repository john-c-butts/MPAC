#!/bin/bash -l
#SBATCH --job-name=cosmic_with_indels
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
#get vcf
vcf_file="/projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/cosmic/processed_data/chrom_vcfs/chr${SLURM_ARRAY_TASK_ID}_cosmic_wgs_ncv.vcf"
...
--output /projects/tewhey-lab/buttsj/Variant_Effects/revision_experiments/cosmic/processed_data/mpac_preds/chr${SLURM_ARRAY_TASK_ID}_cosmic_wgs_v98.vcf \
--window_size 200 \
--relative_start 9 \
--relative_end 180 \
--step_size 10 \
