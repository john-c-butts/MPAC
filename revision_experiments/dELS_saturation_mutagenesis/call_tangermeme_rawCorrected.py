...
def tensors4seqlets_and_plotLogo(stacked_tensor_dict, enhancer_list):
    ...
    return recursive_seqlet_dict, plot_logo_dict
...
def main():
    ...
    tensors, incomplete_ids = satmut2tangerTensor(preds)
    ...
    seqlets_dict, plotLogo_dict = tensors4seqlets_and_plotLogo(tensor_stack, enh_order)
    print()
